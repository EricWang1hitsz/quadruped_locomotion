...
namespace free_gait {
/**
 * @brief BaseAuto::BaseAuto, default constructor
 */
BaseAuto::BaseAuto()
...
/**
 * @brief BaseAuto::BaseAuto, constructor for class clone
 * @param other
 */
...
/**
 * @brief BaseAuto::prepareComputation, pose optimization
 * @param state
 * @param step
 * @param queue
 * @param adapter
...
{
  // if exist previous step, keep the height same as the previous
  ...
  // for the fisrt step, use the average height legs
  unsigned n = 0;
  double heightSum = 0;
  for (const auto& limb : adapter.getLimbs()) {
...
/**
 * @brief BaseAuto::generateFootholdLists, calculate
 * @param state
 * @param step
 * @param queue
 * @param adapter
...
/**
 * @brief BaseAuto::computeDuration
 * @param state
 * @param step
 * @param adapter
 */
