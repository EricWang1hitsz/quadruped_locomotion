...
//  x_.resize(variable_dimension_);
  std::cout<<"quadratic problem solver:: construct a quadratic program solver class"<<std::endl;

};
QuadraticProblemSolver::~QuadraticProblemSolver()
{
  std::cout<<"quadratic problem solver:: quadratic program solver class destroyed"<<std::endl;
}
